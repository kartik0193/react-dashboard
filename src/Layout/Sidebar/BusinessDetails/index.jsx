...
const BusinessDetailsForm = () => {
    ...
    const addPhone = () =>
        setPhoneNumbers([...phoneNumbers, { country: "US", number: "+1 344 434 4455" }]);

    const removePhone = (index) =>
        setPhoneNumbers(phoneNumbers.filter((ele, i) => i !== index));
    ...
    return (
        <div className="border_gray rounded-xl businessDetailsForm shadow p-6 w-full">
            ...
            {phoneNumbers?.length ? <div className="formInput phoneInput">
            ...
            <div className="showMobile">
                ...
                <div className="flex lg:flex-col ">
                    <div className="businessAmountBox formInput w-full">
